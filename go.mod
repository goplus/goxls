...
require (
	...
	github.com/goplus/gop v1.1.13 // indirect
...
replace (
	golang.org/x/tools => github.com/goplus/tools v0.13.5
	golang.org/x/tools/gopls => github.com/goplus/tools/gopls v0.13.5
)
